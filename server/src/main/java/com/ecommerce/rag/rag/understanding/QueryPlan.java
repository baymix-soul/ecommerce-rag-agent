...
public class QueryPlan {
    ...
    public static final String INTENT_CART_SUMMARY = "CART_SUMMARY";
    public static final String INTENT_CART_TOP_UP = "CART_TOP_UP";
    public static final String INTENT_CART_COMPLETION_RECOMMEND = "CART_COMPLETION_RECOMMEND";
    ...
    public static final String CONTEXT_ACTION_READ_CART = "READ_CART";
    public static final String CONTEXT_ACTION_READ_CART_AND_RECOMMEND = "READ_CART_AND_RECOMMEND";
    ...
    public CartPlan getCart() { return cart; }
    public void setCart(CartPlan cart) { this.cart = cart; }
    ...
    public QueryPlan deepCopy() {
        ...
        if (this.cart != null) {
            copy.setCart(this.cart.deepCopy());
        }
        return copy;
    }
}
