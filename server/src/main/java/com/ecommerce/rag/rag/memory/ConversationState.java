...
public class ConversationState {
    ...
    private com.ecommerce.rag.rag.query.QueryAnalysisResult lastAnalysis;
    private String lastNoMatchReason;
    private boolean lastNoMatchRecovered;
    ...
    // Conversation Context v2 getters/setters
    ...
    public com.ecommerce.rag.rag.query.QueryAnalysisResult getLastAnalysis() { return lastAnalysis; }
    public void setLastAnalysis(com.ecommerce.rag.rag.query.QueryAnalysisResult lastAnalysis) { this.lastAnalysis = lastAnalysis; }
    ...
    public boolean isLastNoMatchRecovered() { return lastNoMatchRecovered; }
    public void setLastNoMatchRecovered(boolean lastNoMatchRecovered) { this.lastNoMatchRecovered = lastNoMatchRecovered; }
}
