...
@SpringBootTest
class ChatServiceAssistNoRegressionTest {

    @Autowired
    private ChatService chatService;

    @Test
    void recommendOneRunningShoeShouldReturnOneCard() throws Exception {
    ...
    void refineToLightweightShouldNotReturnBackpack() throws Exception {
        ...
        req1.setSessionId("test-assist-no-reg-light");
        req1.setLimit(5);
        ...
        req2.setSessionId("test-assist-no-reg-light");
        req2.setLimit(5);
    ...
    void budget1000ShouldNotExceedPrice() throws Exception {
        ChatRequest req1 = new ChatRequest();
        req1.setMessage("推荐跑鞋");
        req1.setSessionId("test-assist-no-reg-budget");
        req1.setLimit(5);
        ...
        req2.setSessionId("test-assist-no-reg-budget");
        req2.setLimit(5);
    ...
    void noMatchShouldNotSendProductCard() throws Exception {
        ...
        request.setSessionId("test-assist-no-match");
        request.setLimit(10);
        ...
        req2.setSessionId("test-assist-no-match");
        req2.setLimit(10);
    ...
    void productDetailContextShouldStillWork() throws Exception {
        ...
        request.setSessionId("test-assist-no-reg-pd");
        request.setLimit(5);
