...
```text
**1.交互机器人设计**
采用传统电商界面 + 聊天机器人设计,在不破坏用户浏览体验的情况下,给予电商导购服务,极大程度提高了用户体验和使用频次.
**2.多轮对话 + 反选**
支持多轮对话商品推荐,可以理解"不要xxx","除了xxx"等反选问题.
**3.支持多语义理解**
理解"你好","你是谁"这类非检索问题,减少一切问题都走检索的消耗.
**4.语音多模态**
支持语音多模态,可以输入输出语音交互.
**5.对话购物车加购 + 凑单**
可以实现对话式购物车加购,"帮我下单""帮我加入购物车".还有凑单服务,可以实现阅读当前购物车,以及凑单服务.
**6.界面阅读能力**
可以获取当前浏览界面信息,进行针对性问题提问.例如"这款适合敏感肌吗?"
```
